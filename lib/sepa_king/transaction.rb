...
module SEPA
  class Transaction
    ...
    attr_accessor :name, :iban, :bic, :amount, :instruction, :reference, :remittance_information, :requested_date,
                  :batch_booking, :remittance_information_structured
    convert :name, :instruction, :reference, :remittance_information, :remittance_information_structured, to: :text
    ...
    validates_length_of :remittance_information_structured, within: 1..28, allow_nil: true
